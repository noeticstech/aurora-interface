...
interface BlogSectionProps {
  /** Pass the Portfolio scroll container so GSAP triggers work inside the overflow scroller */
...
const BlogSection = ({ scrollContainerRef }: BlogSectionProps) => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // Ensure ScrollTrigger recalculates once images/layout have settled
  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen py-24 overflow-hidden">
      ...
      <div
        className="absolute bottom-40 left-16 w-3 h-3 rounded-full bg-accent/40 animate-pulse"
        style={{ animationDelay: '1s' }}
      />
      <div
        className="absolute top-1/2 right-32 w-1.5 h-1.5 rounded-full bg-primary/50 animate-pulse"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="mb-16">
          ...
          >
            Exploring the intersection of aesthetics and functionality. Ideas that shape the digital
            landscape.
          </p>
