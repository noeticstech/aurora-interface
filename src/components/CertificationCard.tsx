...
export default function CertificationCard({ certification, isActive }: CertificationCardProps) {
  return (
    <AnimatePresence mode="wait">
      {isActive && (
        <motion.div
          ...
          className="cert-card w-full max-w-md rounded-2xl overflow-hidden hover-lift animate-pulse-gold"
        >
